            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="?page=masuk"><i class="icon nalika-download icon-wrap"></i> <span class="mini-click-non">Kas Masuk</span></a>
                        </li>
                        <li>
                            <a href="?page=keluar" aria-expanded="false"><i class="icon nalika-upload icon-wrap"></i> <span class="mini-click-non">Kas Keluar</span></a>
                        </li>
                        <li>
                            <a href="?page=rekap" aria-expanded="false"><i class="icon nalika-table icon-wrap"></i> <span class="mini-click-non">Rekapitulasi Kas</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
