...
<head>
    ...
    <title>Login | Pengelolaan Kas OP2N</title>
    ...
    <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        <form action="ceklogin.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" title="Please enter your password" placeholder="password" name="password" class="form-control">
                            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <p color="white"> Copyright © 2023 Sistem Informasi Pengelolaan Kas OP2N</p>
            </div>
        </div>
    </div>
