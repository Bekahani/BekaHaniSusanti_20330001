                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a id="edit_data" data-toggle="modal" data-target="#edit<?= $data['kode'] ?>" data-id="<?php echo $data['kode']; ?>" data-ket="<?php echo $data['keterangan']; ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['keluar']; ?>" class="btn btn-warning btn-sm" title="Ubah Data"><i class="fa fa-edit"> </i></a>
