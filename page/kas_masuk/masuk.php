                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a id="edit_data" data-toggle="modal" data-target="#edit<?= $data['kode'] ?>" data-id="<?php echo $data['kode']; ?>" data-ket="<?php echo $data['keterangan']; ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['jumlah']; ?>" class="btn btn-warning btn-md" title="Ubah Data"><i class="fa fa-edit"> </i></a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" id="modal_edit">
                                                <form role="form" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Jumlah</label>
                                                        <input class="form-control" value="<?= $data['jumlah'] ?>" type="number" name="jml" id="jml" />
                                                    </div>
                                            </div>
